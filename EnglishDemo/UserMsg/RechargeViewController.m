...
-(void)newStrategyView{
    ...
    strategy1.layer.borderColor=ssRGBHex(0x9B9B9B).CGColor;
    ...
    strategy2.layer.borderColor=ssRGBHex(0x9B9B9B).CGColor;
    ...
    strategy3.layer.borderColor=ssRGBHex(0x9B9B9B).CGColor;
    ...
    strategy4.layer.borderColor=ssRGBHex(0x9B9B9B).CGColor;
