        ...
        if (btn.tag==rightAnswer) {
            ...
            if (![super.testType isEqualToString:@"wrong"]) {
                [MyThreadPool executeJob:^{
                    ...
                    if ([super.testType isEqualToString:@"word"]) {
                        subjectType=@"2";
                        [sender postRequestWithHead:[[ConnectionFunction getInstance]addWrongMsg_Post_H:[NSString stringWithFormat:@"%@",[[super.testArray objectAtIndex:super.testFlag]valueForKey:@"wordId"]]
                        Type:subjectType]
                        Head:[super.userInfo valueForKey:@"userKey"]
                        Block:myBlock];
                    }else{
                        subjectType=@"1";
                        [sender postRequestWithHead:[[ConnectionFunction getInstance]addWrongMsg_Post_H:[NSString stringWithFormat:@"%@",[[super.testArray objectAtIndex:super.testFlag]valueForKey:@"sentenceId"]]
                        Type:subjectType]
                        Head:[super.userInfo valueForKey:@"userKey"]
                        Block:myBlock];
                    }
